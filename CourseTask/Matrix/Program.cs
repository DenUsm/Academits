...
namespace Matrix
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Matrix mat17 = new Matrix(new double[,] { { 0, 7, 6 }, { 3, 16, 19 }, { 13, 10, 7 } });
            ...
            Matrix mat19 = new Matrix(new double[,] { { 0, 7, 6 }, { 3, 16, 19 }, { 0, 10, 7 } });
            double res2 = mat19.GetDeterminant();
            Console.WriteLine("Determenet matrix " + res2);
